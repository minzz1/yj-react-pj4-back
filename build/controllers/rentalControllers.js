...
var _response = _interopRequireDefault(require("express/lib/response.js"));
    ...
    (Context.prototype = {
      ...
      dispatchException: function dispatchException(exception) {
        ...
        function handle(loc, caught) {
          return (
            (record.type = "throw"), (record.arg = exception), (context.next = loc), caught && ((context.method = "next"), (context.arg = undefined)), !!caught
          );
        }
